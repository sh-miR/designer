...
def serialize(name, flanks3_s, flanks3_a, flanks5_s, flanks5_a, loop_s, loop_a, miRNA_s, miRNA_a, miRNA_length, miRNA_min, miRNA_max, structure, homogeneity, miRBase_link):
    return {
        'name': name,
        'flanks3_s': flanks3_s,
        'flanks3_a': flanks3_a,
